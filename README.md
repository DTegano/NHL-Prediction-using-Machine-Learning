...
This is part 2 of my main overall project. In order to predict games, I believe the NHL data needs to be structured in a specific way. In this case, I am predicting games based on the cumulative stats for each team up until the predicted game. If you haven't read Part 1 of this project, feel free to check out this link: https://github.com/DTegano/Web-Scraping-NHL-Data-for-Prediction-using-Machine-Learning.
